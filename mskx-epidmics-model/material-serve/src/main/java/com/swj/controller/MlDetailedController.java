...
public class MlDetailedController extends ApiController {
     ...
     */
    @GetMapping
    public R selectAll(Page<MlDetailed> page, MlDetailed mlDetailed) {
        return success(this.mlDetailedService.page(page, new QueryWrapper<>(mlDetailed)));
    }
